...
-- Cave Chiller ( male )
mobs:register_mob("mobs_stoneage:cTBc", {
	-- animal, monster, npc
	name = "cTBc",
	type = "tb", "npc",
	knock_back = .9,
	...
	drawtype = "front",
	textures = {
		{"TB_cc1.png",	"3d_armor_trans.png",	minetest.registered_items["mobs_stoneage:weapon_cudgel"].inventory_image,},
...
-- Cave Chiller ( female )
mobs:register_mob("mobs_stoneage:cTBcf", {
	-- animal, monster, npc
	name = "cTBc",
	type = "tb", "npc",
	knock_back = 1.2,
	...
	drawtype = "front",
	textures = {
		{"TB_cc1f.png",	"3d_armor_trans.png",	minetest.registered_items["mobs_stoneage:weapon_cudgel"].inventory_image,},
--		{"TA_cc3.png",	"3d_armor_trans.png",	minetest.registered_items["mobs_stoneage:weapon_cudgel"].inventory_image,},
--		{"TA_cc4.png",	"3d_armor_trans.png",	minetest.registered_items["mobs_stoneage:weapon_cudgel"].inventory_image,},
--		{"TA_cc5.png",	"3d_armor_trans.png",	minetest.registered_items["mobs_stoneage:weapon_cudgel"].inventory_image,},
--		{"TA_cc6.png",	"3d_armor_trans.png",	minetest.registered_items["mobs_stoneage:weapon_cudgel"].inventory_image,},
...
-- Cave Villain
mobs:register_mob("mobs_stoneage:cTBv", {
	-- animal, monster, npc
	name = "Cave Villain A",
	type = "ta", "npc",
...
-- Cave Hunter
mobs:register_mob("mobs_stoneage:cTBh", {
	-- animal, monster, npc
	name = "cTAh",
	type = "ta", "npc",
	-- aggressive, shoots shuriken
...
mobs:register_egg("mobs_stoneage:cTBc", "Cave Chiller m (TB)", "default_leaves.png", 1)
mobs:register_egg("mobs_stoneage:cTBcf", "Cave Chiller f (TB)", "default_leaves.png", 1)
